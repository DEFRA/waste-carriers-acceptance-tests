...
When(/^I complete my registration of my local authority as a lower tier waste carrier$/) do
...
Given(/^I complete my registration of a sole trader business as a lower tier waste carrier$/) do
...
Given(/^I have completed my application of my limited company as a lower tier waste carrier$/) do
