class ManualAddressPage < SitePrism::Page
  ...
  # Next lines only appear in some cases - eg international renewals:
  element(:postcode, "#company_address_manual_form_company_address_postcode")
  element(:country, "#company_address_manual_form_company_address_country")
